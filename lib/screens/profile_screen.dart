                  ...
                  children: [
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          const CircleAvatar(
                              radius: 45, backgroundImage: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYmZpngqCm3sCyZQn0mWGB765SJvwj57oeYw&usqp=CAU")),
                          const SizedBox(height: 10),
                          _textUtils.normal16("Deandra Acil", Colors.white)
                        ],
                      ),
                    ),
                    Expanded(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              _textUtils.bold20("9", Colors.white),
                          ...
                          Column(
                            children: [
                              _textUtils.bold20("6T", Colors.white),
                              const SizedBox(height: 5),
